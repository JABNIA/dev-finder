...
export default function Heading(props: colorTheme) {

    document.body.style.backgroundColor = props.isLight ? "#ededef" : 'rgb(26, 26, 73)';
    document.body.style.color = props.isLight ? "#black" : '#FFFFFF';
    
    
    function changeTheme(event: React.MouseEvent<HTMLHeadingElement>){
